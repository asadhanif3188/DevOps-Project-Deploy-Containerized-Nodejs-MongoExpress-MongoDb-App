...
## Step 08: See MongoDB Managment Page, i.e. Mongo-Express
We are able to see the mongo-express in action using our browser. But before this we need a URL, generated by Minikube, so that it is accessible. 
